...
<div className="flex justify-center items-center mb-4">
  <span className=" text-green-900 bg-green-200 font-semibold px-4 py-1 rounded-full mb-6 text-lg uppercase tracking-wider">
    Reach Out To Us
  </span>
</div>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
    ...
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        <a href="tel:+12344567789" className="text-green-300 text-lg font-medium hover:underline">
          +91-96618 29944
        </a>
      </div>
    </div>
      ...
      <div className="max-w-5xl w-full mx-auto mt-20 bg-transparent p-3 rounded-lg shadow-lg flex flex-col md:flex-row gap-8 mb-6 overflow-hidden">
        {/* ✅ Form Section */}
        <div className="w-full mx-auto bg-green-900/60 backdrop-blur-md border border-white/80  p-3 md:p-10 rounded-lg flex flex-col gap-6">
  {/* Inputs and Map Row */}
    ...
    <div className="w-full md:w-1/2 flex flex-col gap-10">
      <div>
        ...
        <input
          ...
          className="w-full text-xl border border-white/60 rounded p-2 text-white placeholder-white/80 bg-green-700/50 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-green-400"
  ...
  {/* Bottom Section: Query and Button */}
  <div className="flex flex-col gap-2">
    ...
    />
    <button
      className="bg-green-600 text-white text-lg px-12 py-4 mt-6 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-blue-300  w-fits self-center"
