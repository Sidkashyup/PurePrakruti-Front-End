...
export const Footer = () => {
	return (
		<footer className="bg-green-900">
			<div className=" text-black p-10 w-4/5 mx-auto">
				<div className="flex flex-col md:flex-row items- gap-8">
					...
					<div className="flex-1 flex flex-col items-center">
						...
						<p className="text-2xl text-white font-semibold"> Pure Prakruti </p>
					</div>

					{/* Company Links */}
					<div className="flex-1 flex flex-col items-center">
						<div className='text-center md:text-left'>
							<h3 className="font-semibold mb-4 text-white text-xl">Company</h3>
						...
						<div className="flex flex-col items-center md:items-start space-y-2 text-white">
							...
							<div className="flex items-center gap-2">
								<img
									src={mail}
									alt="mail"
									className="h-full max-h-6 w-auto filter invert"
								/>
								<a
							...
							<div className="flex items-start gap-2">
								...
								<a
									...
									className="text-md hover:underline text-center md:text-left hover:text-green-300"
								>
							...
							<div className="flex items-center gap-2 text-white">
								...
								<a
									...
									className="text-white text-lg hover:underline hover:text-green-300"
								>
									+91-96618 29944
								</a>
							</div>
              ...
              <FaGoogle />
					...
					<div className="flex flex-col flex-1 gap-6 mx-auto items-center justify-center flex-shrink-0 ">
