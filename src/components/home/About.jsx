  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8 md:mb-12">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold mb-4 md:mb-6">
          <span className="text-black">About </span>
          <span className="text-green-700">Pure Prakruti</span>
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-600 max-w-7xl mx-auto px-2">
      ...
      >
        {[
          ...
          <motion.div
            key={idx}
            className="bg-white w-full sm:w-[90%] md:w-[48%] lg:w-[30%] max-w-[600px] p-8 md:p-10 lg:p-12 shadow-2xl rounded-2xl text-center mx-auto transform transition-transform duration-50 ease-linear mb-4"
          ...
          >
            <h3 className="text-lg sm:text-2xl md:text-3xl font-bold text-green-700 mb-4">{card.title}</h3>
            {card.icon}
            <p className="text-gray-700 text-xs sm:text-lg md:text-xl">{card.description}</p>
          </motion.div>
        ))}
      </motion.div>
    </motion.section>
